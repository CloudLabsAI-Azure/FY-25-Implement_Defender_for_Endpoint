...
1. Now run the following commands:
    ...
    2. Select **Upload file to library (1)**, selecṭ the **Malware script**, and any **Diagnostic script** **(2)** (Select any of the script file which is available in the C drive) to upload. Select **Submit**.
